...
const TEXT = {
  fr: {
    title: "Terre Végétale Tunisie – 70 DT/m³ | Green Garden",
    metaDescription: "Terre végétale en Tunisie à 70 DT/m³, livraison partout dans le pays. Idéale pour gazon, plantation et jardin. Commandez sur WhatsApp avec Green Garden.",
    eyebrow: "Terre végétale",
    h1: "Acheter de la terre végétale en Tunisie",
    heroAlt: "acheter terre végétale en Tunisie",
    intro: "Green Garden vend et livre de la terre végétale partout en Tunisie, au prix clair de 70 DT le mètre cube (m³). Une base essentielle pour préparer un sol avant la pose de gazon, une plantation ou la création d'un massif.",
    breadcrumbLabel: "Acheter terre végétale",
    productDescription: "Terre végétale vendue au m³, livrable dans toute la Tunisie, pour préparer un sol avant gazon, plantation ou création de massif.",
    priceH2: "Le prix de la terre végétale Green Garden",
    priceText: "70 DT le mètre cube (m³), livraison disponible partout en Tunisie. Contactez-nous par WhatsApp avec votre ville pour connaître le tarif de livraison correspondant.",
    ...
    deliveryPa: [
      "Green Garden livre la terre végétale dans toute la Tunisie, y compris le Grand Tunis, Nabeul, Sousse, Monastir, Sfax, Bizerte, Gabès et Hammamet. Le tarif de livraison dépend de la quantité commandée et de votre région : contactez-nous par WhatsApp avec votre ville pour le connaître.",
    ],
    ctaHeading: "Commandez votre terre végétale",
    ctaText: "70 DT/m³, livraison partout en Tunisie. Indiquez-nous la quantité souhaitée et votre ville.",
    ctaButton: "Commander sur WhatsApp",
    ctaMessage: "Bonjour, je souhaite commander de la terre végétale (70 DT/m³). Voici la quantité souhaitée : ",
    ctaSecondary: "Voir la catégorie Terre végétale",
    faqH2: "Questions fréquentes sur la terre végétale",
    faq: [
      ["Quel est le prix de la terre végétale en Tunisie ?", "La terre végétale Green Garden est vendue 70 DT le mètre cube (m³), livraison disponible partout en Tunisie selon un tarif calculé par région."],
      ...
      ["Comment se passe la livraison ?", "Contactez-nous par WhatsApp avec votre ville et la quantité souhaitée : nous vous communiquons le tarif de livraison correspondant avant confirmation de commande."],
  ...
  en: {
    title: "Topsoil Tunisia – 70 DT/m³ Fast Delivery | Green Garden",
    metaDescription: "Topsoil in Tunisia at 70 DT/m³, delivered across the country. Ideal for lawn, planting and gardens. Order on WhatsApp with Green Garden.",
    eyebrow: "Topsoil",
    h1: "Buy topsoil in Tunisia",
    heroAlt: "buy topsoil in Tunisia",
    intro: "Green Garden sells and delivers topsoil across Tunisia, at the clear price of 70 DT per cubic metre (m³). An essential base for preparing soil before laying lawn, planting, or creating a flower bed.",
    breadcrumbLabel: "Buy topsoil",
    productDescription: "Topsoil sold per m³, deliverable across Tunisia, to prepare soil before lawn, planting or a flower bed.",
    priceH2: "The price of Green Garden topsoil",
    priceText: "70 DT per cubic metre (m³), delivery available across Tunisia. Contact us on WhatsApp with your city to get the corresponding delivery rate.",
    ...
    deliveryPa: [
      "Green Garden delivers topsoil across Tunisia, including Greater Tunis, Nabeul, Sousse, Monastir, Sfax, Bizerte, Gabes and Hammamet. The delivery rate depends on the quantity ordered and your region: contact us on WhatsApp with your city to find out.",
    ],
    ctaHeading: "Order your topsoil",
    ctaText: "70 DT/m³, delivery across Tunisia. Tell us the quantity you need and your city.",
    ctaButton: "Order on WhatsApp",
    ctaMessage: "Hello, I would like to order topsoil (70 DT/m³). Here is the quantity I need: ",
    ctaSecondary: "See the Topsoil category",
    faqH2: "Frequently asked questions about topsoil",
    faq: [
      ["What is the price of topsoil in Tunisia?", "Green Garden topsoil is sold at 70 DT per cubic metre (m³), with delivery available across Tunisia at a rate calculated by region."],
      ["Is there a minimum order quantity?", "No, there is no imposed minimum: you order the exact volume you need, calculated per m³."],
      ["How does delivery work?", "Contact us on WhatsApp with your city and the quantity needed: we will give you the corresponding delivery rate before confirming your order."],
  ...
  ar: {
    title: "شراء التربة الزراعية تونس – 70 دينار/م³ | Green Garden",
    metaDescription: "تربة زراعية في تونس بسعر 70 دينار/م³، توصيل في كل البلاد. مثالية للعشب والغراسة والحديقة. اطلبوا عبر واتساب مع Green Garden.",
    eyebrow: "التربة الزراعية",
    h1: "شراء التربة في تونس",
    heroAlt: "شراء التربة في تونس",
    intro: "تبيع Green Garden وتوصل التربة الزراعية في كل تونس، بسعر واضح قدره 70 دينار للمتر المكعب (م³). أساس ضروري لتحضير التربة قبل تركيب العشب أو الغراسة أو إنشاء حوض زهور.",
    breadcrumbLabel: "شراء التربة الزراعية",
    productDescription: "تربة زراعية تُباع بالمتر المكعب، قابلة للتوصيل في كل تونس، لتحضير التربة قبل العشب أو الغراسة أو إنشاء حوض.",
    priceH2: "سعر التربة الزراعية من Green Garden",
    priceText: "70 دينار للمتر المكعب (م³)، التوصيل متوفر في كل تونس. تواصلوا معنا عبر واتساب مع مدينتكم لمعرفة تعريفة التوصيل المناسبة.",
    ...
    deliveryPa: [
      "توصل Green Garden التربة الزراعية في كل تونس، بما في ذلك تونس الكبرى ونابل وسوسة والمنستير وصفاقس وبنزرت وقابس والحمامات. تعتمد تعريفة التوصيل على الكمية المطلوبة وجهتكم: تواصلوا معنا عبر واتساب مع مدينتكم لمعرفتها.",
    ],
    ctaHeading: "اطلبوا ترابكم الزراعي",
    ctaText: "70 دينار/م³، توصيل في كل تونس. أذكروا لنا الكمية المرغوبة ومدينتكم.",
    ctaButton: "اطلبوا عبر واتساب",
    ctaMessage: "مرحباً، أود طلب تربة زراعية (70 دينار/م³). إليكم الكمية المرغوبة: ",
    ctaSecondary: "شاهدوا فئة التربة الزراعية",
    faqH2: "أسئلة شائعة حول التربة الزراعية",
    faq: [
      ["ما هو سعر التربة الزراعية في تونس؟", "تُباع تربة Green Garden الزراعية بسعر 70 دينار للمتر المكعب (م³)، مع توصيل متوفر في كل تونس بتعريفة تُحسب حسب الجهة."],
      ["هل توجد كمية دنيا للطلب؟", "لا، لا يوجد حد أدنى مفروض: تطلبون الحجم الدقيق الذي تحتاجونه، محسوباً بالمتر المكعب."],
      ["كيف يتم التوصيل؟", "تواصلوا معنا عبر واتساب مع مدينتكم والكمية المرغوبة: سنبلغكم بتعريفة التوصيل المناسبة قبل تأكيد الطلب."],
