...
const TEXT = {
  fr: {
    ...
    metaDescription: "Terre végétale en Tunisie à 70 DT/m³, livraison gratuite au Grand Tunis et à Nabeul. Idéale pour gazon et plantation. Commandez sur WhatsApp.",
    eyebrow: "Terre végétale",
    h1: "Acheter de la terre végétale en Tunisie",
    heroAlt: "acheter terre végétale en Tunisie",
    intro: "Green Garden vend et livre de la terre végétale partout en Tunisie, au prix clair de 70 DT le mètre cube (m³), avec livraison gratuite dans le Grand Tunis et à Nabeul. Une base essentielle pour préparer un sol avant la pose de gazon, une plantation ou la création d'un massif.",
    ...
    priceText: "70 DT le mètre cube (m³), avec livraison gratuite dans le Grand Tunis et à Nabeul. Ailleurs en Tunisie, la livraison reste possible et le tarif vous est communiqué selon votre région.",
    ...
    ctaText: "70 DT/m³, livraison gratuite au Grand Tunis et à Nabeul. Indiquez-nous la quantité souhaitée et votre ville.",
    ...
    faq: [
      ["Quel est le prix de la terre végétale en Tunisie ?", "La terre végétale Green Garden est vendue 70 DT le mètre cube (m³). La livraison est gratuite dans le Grand Tunis et à Nabeul ; ailleurs en Tunisie, elle est facturée sur devis selon la distance."],
  ...
  en: {
    ...
    metaDescription: "Topsoil in Tunisia at 70 DT/m³, free delivery in Greater Tunis and Nabeul. Ideal for lawn and planting. Order on WhatsApp with Green Garden.",
    eyebrow: "Topsoil",
    h1: "Buy topsoil in Tunisia",
    heroAlt: "buy topsoil in Tunisia",
    intro: "Green Garden sells and delivers topsoil across Tunisia, at the clear price of 70 DT per cubic metre (m³), with free delivery in Greater Tunis and Nabeul. An essential base for preparing soil before laying lawn, planting, or creating a flower bed.",
    ...
    priceText: "70 DT per cubic metre (m³), with free delivery in Greater Tunis and Nabeul. Elsewhere in Tunisia delivery remains available, with a rate given for your region.",
    ...
    ctaText: "70 DT/m³, free delivery in Greater Tunis and Nabeul. Tell us the quantity you need and your city.",
    ...
    faq: [
      ["What is the price of topsoil in Tunisia?", "Green Garden topsoil is sold at 70 DT per cubic metre (m³). Delivery is free in Greater Tunis and Nabeul; elsewhere in Tunisia it is charged on quote based on distance."],
  ...
  ar: {
    ...
    metaDescription: "تربة زراعية في تونس بسعر 70 دينار/م³، توصيل مجاني في تونس الكبرى ونابل. مثالية للعشب والغراسة. اطلبوا عبر واتساب مع Green Garden.",
    eyebrow: "التربة الزراعية",
    h1: "شراء التربة في تونس",
    heroAlt: "شراء التربة في تونس",
    intro: "تبيع Green Garden وتوصل التربة الزراعية في كل تونس، بسعر واضح قدره 70 دينار للمتر المكعب (م³)، مع توصيل مجاني في تونس الكبرى ونابل. أساس ضروري لتحضير التربة قبل تركيب العشب أو الغراسة أو إنشاء حوض زهور.",
    ...
    priceText: "70 دينار للمتر المكعب (م³)، مع توصيل مجاني في تونس الكبرى ونابل. في بقية تونس يبقى التوصيل متاحاً، وتُبلَّغ التعريفة حسب جهتكم.",
    ...
    ctaText: "70 دينار/م³، توصيل مجاني في تونس الكبرى ونابل. أذكروا لنا الكمية المرغوبة ومدينتكم.",
    ...
    faq: [
      ["ما هو سعر التربة الزراعية في تونس؟", "تُباع تربة Green Garden الزراعية بسعر 70 دينار للمتر المكعب (م³). التوصيل مجاني في تونس الكبرى ونابل؛ في بقية تونس يُحتسب حسب الطلب وحسب المسافة."],
