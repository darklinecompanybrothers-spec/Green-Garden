...
const HOME_TEXT = {
  fr: {
    ...
    flagshipH2: "Nos produits phares",
    ...
    flagshipCards: [
      [`Gazon naturel — ${SITE.products.gazon.priceLabel}`, "Livraison calculée selon votre adresse. Pose rapide, rendu immédiat.", "/gazon-tunisie/", "/gazon.jpg"],
      [`Palmier décoratif — ${SITE.products.palmier.priceLabel}`, "Livraison calculée selon votre adresse.", "/palmier-tunisie/", "/palmier-eventail.jpeg"],
      [`Terre végétale — ${SITE.products.terreVegetale.priceLabel}`, "Livraison calculée selon votre adresse. Idéale pour préparer un sol avant gazon ou plantation.", "/acheter-terre-vegetale/", "/acheter-terre-vegetale-tunisie.jpg"],
    ...
    palmierCopy: "Palmier décoratif à 490 DT/m, livraison calculée selon votre adresse partout en Tunisie.",
    palmierCta: "Découvrir les palmiers",
    palmierCtaSecondary: "Comment l'acheter",
    deliveryH2: "Livraison partout en Tunisie",
    deliveryIntro: "Gazon et palmier livrés dans toute la Tunisie, avec des frais de livraison calculés selon votre adresse.",
    deliveryCards: [
      ["Grand Tunis", "Gazon et palmier livrés rapidement, frais selon votre adresse.", "/livraison/grand-tunis/", "/123699.jpeg"],
      ["Nabeul", "Notre région de base : délais les plus courts, frais selon votre adresse.", "/livraison/nabeul/", "/gazon.jpg"],
  ...
  en: {
    ...
    flagshipH2: "Our flagship products",
    ...
    flagshipCards: [
      [`Natural lawn — ${SITE.products.gazon.priceLabel}`, "Delivery quoted by address. Fast laying, instant result.", "/gazon-tunisie/", "/gazon.jpg"],
      [`Decorative palm tree — ${SITE.products.palmier.priceLabel}`, "Delivery quoted by address.", "/palmier-tunisie/", "/palmier-eventail.jpeg"],
      [`Topsoil — ${SITE.products.terreVegetale.priceLabel}`, "Delivery quoted by address. Ideal to prepare soil before lawn or planting.", "/acheter-terre-vegetale/", "/acheter-terre-vegetale-tunisie.jpg"],
    ...
    palmierCopy: "Decorative palm tree at 490 DT/m, delivery quoted by address anywhere in Tunisia.",
    palmierCta: "Discover our palm trees",
    palmierCtaSecondary: "How to buy it",
    deliveryH2: "Delivery across Tunisia",
    deliveryIntro: "Lawn and palm tree delivered across Tunisia, with delivery fees calculated for your address.",
    deliveryCards: [
      ["Greater Tunis", "Lawn and palm tree delivered fast, fees quoted by address.", "/livraison/grand-tunis/", "/123699.jpeg"],
      ["Nabeul", "Our home base: shortest lead times, fees quoted by address.", "/livraison/nabeul/", "/gazon.jpg"],
  ...
  ar: {
    ...
    flagshipH2: "منتجاتنا الرئيسية",
    flagshipIntro: "مراجع مصممة لتحويل مساحة خارجية تونسية بسرعة: العشب الطبيعي على شكل لفائف، نخيل الزينة والتربة الزراعية.",
    flagshipCards: [
      [`عشب طبيعي — ${SITE.products.gazon.priceLabel}`, "توصيل حسب عنوانكم. تركيب سريع، نتيجة فورية.", "/gazon-tunisie/", "/gazon.jpg"],
      [`نخيل زينة — ${SITE.products.palmier.priceLabel}`, "توصيل حسب عنوانكم.", "/palmier-tunisie/", "/palmier-eventail.jpeg"],
      [`تربة زراعية — ${SITE.products.terreVegetale.priceLabel}`, "توصيل حسب عنوانكم. مثالية لتحضير التربة قبل العشب أو الغراسة.", "/acheter-terre-vegetale/", "/acheter-terre-vegetale-tunisie.jpg"],
    ...
    palmierCopy: "نخلة زينة بسعر 490 دينار/م، توصيل حسب عنوانكم في كل تونس.",
    palmierCta: "اكتشفوا النخيل",
    palmierCtaSecondary: "كيف تشترونه",
    deliveryH2: "توصيل في كل أنحاء تونس",
    deliveryIntro: "عشب ونخيل يُوصَّلان في كل تونس، بمصاريف توصيل تُحتسب حسب عنوانكم.",
    deliveryCards: [
      ["تونس الكبرى", "عشب ونخلة يُوصَّلان بسرعة، بمصاريف حسب عنوانكم.", "/livraison/grand-tunis/", "/123699.jpeg"],
      ["نابل", "جهتنا الأساسية: أقصر الآجال، بمصاريف حسب عنوانكم.", "/livraison/nabeul/", "/gazon.jpg"],
