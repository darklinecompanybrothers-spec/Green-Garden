...
const HOME_TEXT = {
  fr: {
    ...
    flagshipCards: [
      ...
      [`Terre végétale — ${SITE.products.terreVegetale.priceLabel}`, "Livraison gratuite au Grand Tunis et à Nabeul. Idéale pour préparer un sol avant gazon ou plantation.", "/acheter-terre-vegetale/", "/acheter-terre-vegetale-tunisie.jpg"],
    ...
    palmierCopy: "Palmier décoratif à 490 DT/m, livraison gratuite dans le Grand Tunis et à Nabeul, sur devis ailleurs en Tunisie.",
  ...
  en: {
    ...
    flagshipCards: [
      ...
      [`Topsoil — ${SITE.products.terreVegetale.priceLabel}`, "Free delivery in Greater Tunis and Nabeul. Ideal to prepare soil before lawn or planting.", "/acheter-terre-vegetale/", "/acheter-terre-vegetale-tunisie.jpg"],
    ...
    palmierCopy: "Decorative palm tree at 490 DT/m, free delivery in Greater Tunis and Nabeul, on quote elsewhere in Tunisia.",
  ...
  ar: {
    ...
    description: "عشب طبيعي بسعر 9 دينار/م² (توصيل مجاني في تونس الكبرى ونابل) ونخيل زينة بسعر 490 دينار/م في تونس. نباتات داخلية وأسمدة.",
    ...
    flagshipCards: [
      ...
      [`تربة زراعية — ${SITE.products.terreVegetale.priceLabel}`, "توصيل مجاني في تونس الكبرى ونابل. مثالية لتحضير التربة قبل العشب أو الغراسة.", "/acheter-terre-vegetale/", "/acheter-terre-vegetale-tunisie.jpg"],
    ...
    palmierCopy: "نخلة زينة بسعر 490 دينار/م، توصيل مجاني في تونس الكبرى ونابل، حسب الطلب في بقية تونس.",
