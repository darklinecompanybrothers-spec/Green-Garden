...
const HOME_TEXT = {
  fr: {
    ...
    flagshipCards: [
      ...
      [`Palmier décoratif — ${SITE.products.palmier.priceLabel}`, "Livrable dans toute la Tunisie, frais calculés selon votre région.", "/palmier-tunisie/", "/Palmier éventail.jpeg"],
    ...
    palmierCopy: "Palmier décoratif à 275 DT, livrable dans toute la Tunisie avec des frais de livraison déterminés selon votre région.",
    ...
    deliveryCards: [
      ["Grand Tunis", "Gazon livré gratuitement.", "/livraison/grand-tunis/", "/123699.jpeg"],
      ["Nabeul", "Gazon livré gratuitement.", "/livraison/nabeul/", "/gazon.jpg"],
  ...
  en: {
    ...
    flagshipCards: [
      ...
      [`Decorative palm tree — ${SITE.products.palmier.priceLabel}`, "Deliverable across Tunisia, fees calculated based on your region.", "/palmier-tunisie/", "/Palmier éventail.jpeg"],
    ...
    palmierCopy: "Decorative palm tree at 275 DT, deliverable across Tunisia with delivery fees determined by your region.",
    ...
    deliveryCards: [
      ["Greater Tunis", "Lawn delivered free.", "/livraison/grand-tunis/", "/123699.jpeg"],
      ["Nabeul", "Lawn delivered free.", "/livraison/nabeul/", "/gazon.jpg"],
  ...
  ar: {
    ...
    flagshipCards: [
      ...
      [`نخيل زينة — ${SITE.products.palmier.priceLabel}`, "قابل للتوصيل في كل تونس، مصاريف تُحسب حسب جهتكم.", "/palmier-tunisie/", "/Palmier éventail.jpeg"],
    ...
    palmierCopy: "نخلة زينة بسعر 275 دينار، قابلة للتوصيل في كل تونس بمصاريف تُحدَّد حسب جهتكم.",
    ...
    deliveryCards: [
      ["تونس الكبرى", "عشب يُوصَّل مجاناً.", "/livraison/grand-tunis/", "/123699.jpeg"],
      ["نابل", "عشب يُوصَّل مجاناً.", "/livraison/nabeul/", "/gazon.jpg"],
