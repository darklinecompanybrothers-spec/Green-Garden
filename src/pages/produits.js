...
const LIGHT_CATEGORY_TEXT = {
  ...
  "terre-vegetale": {
    fr: {
      ...
      metaDescription: "Terre végétale Green Garden à 100 DT/m³, livrée partout en Tunisie avec des frais selon votre adresse. Pour préparer massifs, plantations et pelouses.",
      eyebrow: "Catégorie",
      h1: "Terre végétale",
      intro: "Une bonne terre végétale est la base d'un jardin qui pousse bien : elle enrichit le sol avant la pose du gazon, la plantation d'un arbre ou d'un massif. Vendue 100 DT/m³, avec des frais de livraison calculés selon votre adresse.",
      ...
      ctaText: "100 DT/m³, livraison calculée selon votre adresse. Consultez le détail des quantités et commandez sur la page dédiée.",
    ...
    en: {
      ...
      metaDescription: "Green Garden topsoil at 100 DT/m³, delivered across Tunisia with fees quoted by address. To prepare your beds, plantings and lawns.",
      eyebrow: "Category",
      h1: "Topsoil",
      intro: "Good topsoil is the foundation of a garden that grows well: it enriches the soil before laying lawn, planting a tree or setting up a flower bed. Sold at 100 DT/m³, with delivery fees calculated for your address.",
      label: "Topsoil",
      heroImage: "/acheter-terre-vegetale-tunisie.jpg",
      ...
      ctaText: "100 DT/m³, delivery quoted by address. See the full quantity guide and order on the dedicated page.",
    ...
    ar: {
      ...
      metaDescription: "تراب زراعي من Green Garden بسعر 100 دينار/م³، يُوصَّل في كل تونس بمصاريف حسب عنوانكم. لتحضير أحواضكم وغراساتكم وعشبكم.",
      eyebrow: "الفئة",
      h1: "تراب زراعي",
      intro: "التراب الزراعي الجيد هو أساس حديقة تنمو جيداً: فهو يُثري التربة قبل تركيب العشب أو غرس شجرة أو حوض. يُباع بسعر 100 دينار/م³، بمصاريف توصيل تُحتسب حسب عنوانكم.",
      ...
      ctaText: "100 دينار/م³، توصيل حسب عنوانكم. اطلعوا على تفاصيل الكميات واطلبوا في الصفحة المخصصة.",
