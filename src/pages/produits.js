...
const HUB_TEXT = {
  fr: {
    ...
    cards: [
      ...
      ["Terre végétale", "Pour préparer vos massifs et plantations.", "/produits/terre-vegetale/", null],
  ...
  en: {
    ...
    cards: [
      ...
      ["Topsoil", "To prepare your beds and plantings.", "/produits/terre-vegetale/", null],
  ...
  ar: {
    ...
    cards: [
      ...
      ["تراب زراعي", "لتحضير أحواضكم وغراساتكم.", "/produits/terre-vegetale/", null],
...
const LIGHT_CATEGORY_TEXT = {
  ...
  "terre-vegetale": {
    fr: {
      title: "Terre végétale | Green Garden",
      metaDescription: "Terre végétale Green Garden pour préparer vos massifs, plantations et pelouses en Tunisie. Prix sur demande via WhatsApp.",
      eyebrow: "Catégorie",
      h1: "Terre végétale",
      intro: "Une bonne terre végétale est la base d'un jardin qui pousse bien : elle enrichit le sol avant la pose du gazon, la plantation d'un arbre ou d'un massif.",
      ...
      ctaText: "Contactez-nous par WhatsApp pour connaître les quantités disponibles et le prix selon votre projet.",
      ctaButton: "Demander un devis",
      ctaMessage: "Bonjour, je souhaite des informations sur la terre végétale disponible chez Green Garden.",
    },
    en: {
      title: "Topsoil | Green Garden",
      metaDescription: "Green Garden topsoil to prepare your beds, plantings and lawns in Tunisia. Prices on request via WhatsApp.",
      eyebrow: "Category",
      h1: "Topsoil",
      intro: "Good topsoil is the foundation of a garden that grows well: it enriches the soil before laying lawn, planting a tree or setting up a flower bed.",
      label: "Topsoil",
      heroImage: null,
      ...
      ctaText: "Contact us on WhatsApp to find out available quantities and the price for your project.",
      ctaButton: "Request a quote",
      ctaMessage: "Hello, I would like information about the topsoil available at Green Garden.",
    },
    ar: {
      title: "تراب زراعي | Green Garden",
      metaDescription: "تراب زراعي من Green Garden لتحضير أحواضكم وغراساتكم وعشبكم في تونس. الأسعار عند الطلب عبر واتساب.",
      eyebrow: "الفئة",
      h1: "تراب زراعي",
      intro: "التراب الزراعي الجيد هو أساس حديقة تنمو جيداً: فهو يُثري التربة قبل تركيب العشب أو غرس شجرة أو حوض.",
      ...
      ctaText: "تواصلوا معنا عبر واتساب لمعرفة الكميات المتوفرة والسعر حسب مشروعكم.",
