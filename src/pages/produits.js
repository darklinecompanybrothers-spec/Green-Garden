...
const HUB_TEXT = {
  fr: {
    ...
    cards: [
      ...
      ["Palmiers décoratifs — 490 DT/m", "Livraison gratuite Grand Tunis et Nabeul.", "/produits/palmiers/", "/palmier-eventail.jpeg"],
      ...
      ["Terre végétale", "Pour préparer vos massifs et plantations.", "/produits/terre-vegetale/", "/acheter-terre-vegetale-tunisie.jpg"],
  ...
  en: {
    ...
    cards: [
      ...
      ["Decorative palm trees — 490 DT/m", "Free delivery in Greater Tunis and Nabeul.", "/produits/palmiers/", "/palmier-eventail.jpeg"],
      ...
      ["Topsoil", "To prepare your beds and plantings.", "/produits/terre-vegetale/", "/acheter-terre-vegetale-tunisie.jpg"],
  ...
  ar: {
    ...
    cards: [
      ...
      ["نخيل زينة — 490 دينار/م", "توصيل مجاني في تونس الكبرى ونابل.", "/produits/palmiers/", "/palmier-eventail.jpeg"],
      ...
      ["تراب زراعي", "لتحضير أحواضكم وغراساتكم.", "/produits/terre-vegetale/", "/acheter-terre-vegetale-tunisie.jpg"],
...
const CATEGORY_TEXT = {
  ...
  palmiers: {
    fr: {
      ...
      metaDescription: "La catégorie palmiers décoratifs de Green Garden : palmier à 490 DT/m, livraison gratuite Grand Tunis et Nabeul, sur devis ailleurs.",
      eyebrow: "Catégorie",
      h1: "Palmiers décoratifs",
      intro: "Notre catégorie palmiers regroupe le palmier décoratif d'ornement, vendu 490 DT/m. La livraison est gratuite dans le Grand Tunis et à Nabeul, et organisée sur devis dans le reste de la Tunisie.",
      label: "Palmiers",
      relatedH2: "Voir aussi",
      related: [
    ...
    en: {
      ...
      metaDescription: "Green Garden's decorative palm tree category: palm tree at 490 DT/m, free delivery in Greater Tunis and Nabeul, on quote elsewhere.",
      eyebrow: "Category",
      h1: "Decorative palm trees",
      intro: "Our palm tree category covers the ornamental decorative palm tree, sold at 490 DT/m. Delivery is free in Greater Tunis and Nabeul, and arranged on quote across the rest of Tunisia.",
      label: "Palm trees",
      relatedH2: "See also",
      related: [
    ...
    ar: {
      ...
      metaDescription: "فئة نخيل الزينة من Green Garden: نخلة بسعر 490 دينار/م، توصيل مجاني في تونس الكبرى ونابل، حسب الطلب في بقية الجهات.",
      eyebrow: "الفئة",
      h1: "نخيل زينة",
      intro: "تضم فئة النخيل لدينا نخلة الزينة، تُباع بسعر 490 دينار/م. التوصيل مجاني في تونس الكبرى ونابل، ومُنظَّم حسب الطلب في بقية تونس.",
      label: "النخيل",
      relatedH2: "شاهدوا أيضاً",
      related: [
...
const LIGHT_CATEGORY_TEXT = {
  ...
  "terre-vegetale": {
    fr: {
      title: "Terre végétale | 100 DT/m³ - Green Garden",
      metaDescription: "Terre végétale Green Garden à 100 DT/m³, livraison gratuite au Grand Tunis et à Nabeul. Pour préparer massifs, plantations et pelouses.",
      eyebrow: "Catégorie",
      h1: "Terre végétale",
      intro: "Une bonne terre végétale est la base d'un jardin qui pousse bien : elle enrichit le sol avant la pose du gazon, la plantation d'un arbre ou d'un massif. Vendue 100 DT/m³, livrée gratuitement dans le Grand Tunis et à Nabeul.",
      ...
      ctaText: "100 DT/m³, livraison gratuite au Grand Tunis et à Nabeul. Consultez le détail des quantités et commandez sur la page dédiée.",
    ...
    en: {
      title: "Topsoil | 100 DT/m³ - Green Garden",
      metaDescription: "Green Garden topsoil at 100 DT/m³, free delivery in Greater Tunis and Nabeul. To prepare your beds, plantings and lawns.",
      eyebrow: "Category",
      h1: "Topsoil",
      intro: "Good topsoil is the foundation of a garden that grows well: it enriches the soil before laying lawn, planting a tree or setting up a flower bed. Sold at 100 DT/m³, delivered free in Greater Tunis and Nabeul.",
      label: "Topsoil",
      heroImage: "/acheter-terre-vegetale-tunisie.jpg",
      ...
      ctaText: "100 DT/m³, free delivery in Greater Tunis and Nabeul. See the full quantity guide and order on the dedicated page.",
    ...
    ar: {
      title: "تراب زراعي | 100 دينار/م³ - Green Garden",
      metaDescription: "تراب زراعي من Green Garden بسعر 100 دينار/م³، توصيل مجاني في تونس الكبرى ونابل. لتحضير أحواضكم وغراساتكم وعشبكم.",
      eyebrow: "الفئة",
      h1: "تراب زراعي",
      intro: "التراب الزراعي الجيد هو أساس حديقة تنمو جيداً: فهو يُثري التربة قبل تركيب العشب أو غرس شجرة أو حوض. يُباع بسعر 100 دينار/م³، ويُوصَّل مجاناً في تونس الكبرى ونابل.",
      ...
      ctaText: "100 دينار/م³، توصيل مجاني في تونس الكبرى ونابل. اطلعوا على تفاصيل الكميات واطلبوا في الصفحة المخصصة.",
