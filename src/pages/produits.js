...
const HUB_TEXT = {
  fr: {
    ...
    cards: [
      ...
      ["Palmiers décoratifs — 275 DT", "Livraison gratuite Grand Tunis et Nabeul.", "/produits/palmiers/", "/palmier-eventail.jpeg"],
  ...
  en: {
    ...
    cards: [
      ...
      ["Decorative palm trees — 275 DT", "Free delivery in Greater Tunis and Nabeul.", "/produits/palmiers/", "/palmier-eventail.jpeg"],
  ...
  ar: {
    ...
    cards: [
      ...
      ["نخيل زينة — 275 دينار", "توصيل مجاني في تونس الكبرى ونابل.", "/produits/palmiers/", "/palmier-eventail.jpeg"],
...
const LIGHT_CATEGORY_TEXT = {
  ...
  "terre-vegetale": {
    fr: {
      ...
      metaDescription: "Terre végétale Green Garden à 70 DT/m³, livraison gratuite au Grand Tunis et à Nabeul. Pour préparer massifs, plantations et pelouses.",
      eyebrow: "Catégorie",
      h1: "Terre végétale",
      intro: "Une bonne terre végétale est la base d'un jardin qui pousse bien : elle enrichit le sol avant la pose du gazon, la plantation d'un arbre ou d'un massif. Vendue 70 DT/m³, livrée gratuitement dans le Grand Tunis et à Nabeul.",
      ...
      ctaText: "70 DT/m³, livraison gratuite au Grand Tunis et à Nabeul. Consultez le détail des quantités et commandez sur la page dédiée.",
    ...
    en: {
      ...
      metaDescription: "Green Garden topsoil at 70 DT/m³, free delivery in Greater Tunis and Nabeul. To prepare your beds, plantings and lawns.",
      eyebrow: "Category",
      h1: "Topsoil",
      intro: "Good topsoil is the foundation of a garden that grows well: it enriches the soil before laying lawn, planting a tree or setting up a flower bed. Sold at 70 DT/m³, delivered free in Greater Tunis and Nabeul.",
      label: "Topsoil",
      heroImage: "/acheter-terre-vegetale-tunisie.jpg",
      ...
      ctaText: "70 DT/m³, free delivery in Greater Tunis and Nabeul. See the full quantity guide and order on the dedicated page.",
    ...
    ar: {
      ...
      metaDescription: "تراب زراعي من Green Garden بسعر 70 دينار/م³، توصيل مجاني في تونس الكبرى ونابل. لتحضير أحواضكم وغراساتكم وعشبكم.",
      eyebrow: "الفئة",
      h1: "تراب زراعي",
      intro: "التراب الزراعي الجيد هو أساس حديقة تنمو جيداً: فهو يُثري التربة قبل تركيب العشب أو غرس شجرة أو حوض. يُباع بسعر 70 دينار/م³، ويُوصَّل مجاناً في تونس الكبرى ونابل.",
      ...
      ctaText: "70 دينار/م³، توصيل مجاني في تونس الكبرى ونابل. اطلعوا على تفاصيل الكميات واطلبوا في الصفحة المخصصة.",
