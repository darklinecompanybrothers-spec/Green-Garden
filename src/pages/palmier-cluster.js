...
function palmierCta(lang) {
  const T = {
    ...
    en: {
      ...
      text: `${SITE.products.palmier.priceLabel}. Deliverable across Tunisia, delivery fees determined based on your region.`,
      buttonLabel: "Order on WhatsApp",
      whatsappMessage: "Hello, I would like to order a decorative palm tree (275 DT).",
      secondaryLabel: "See delivery zones",
    },
    ar: {
      heading: "اطلبوا نخلة الزينة الخاصة بكم",
      text: `${SITE.products.palmier.priceLabel}. قابلة للتوصيل في كل تونس، مصاريف التوصيل تُحدَّد حسب جهتكم.`,
      buttonLabel: "اطلبوا عبر واتساب",
      whatsappMessage: "مرحباً، أود طلب نخلة زينة (275 دينار).",
...
function pillarPage(lang) {
  const T = {
    fr: {
      ...
      metaDescription: "Vente de palmier décoratif en Tunisie à 275 DT. Livraison dans toute la Tunisie, frais déterminés selon la région. Commandez sur WhatsApp avec Green Garden.",
      eyebrow: "Palmier décoratif",
      h1: "Palmier Tunisie : palmier décoratif à 275 DT",
      intro: "Green Garden vend et livre des palmiers décoratifs partout en Tunisie, au prix de 275 DT. Les frais de livraison sont déterminés selon votre région et vous sont communiqués avant confirmation de commande.",
      breadcrumbLabel: "Palmier Tunisie",
      productDescription: "Palmier décoratif d'ornement pour jardin, terrasse ou entrée de villa, livrable dans toute la Tunisie.",
      ...
      listB: ["Un sujet adapté au climat tunisien, résistant à la chaleur estivale", "Un effet visuel immédiat pour structurer un jardin, une entrée ou une terrasse", "Un entretien limité une fois le palmier bien installé", "Un prix clair et unique de 275 DT", "Une livraison organisée dans toute la Tunisie, frais calculés selon la région"],
      faqH2: "Questions fréquentes sur le palmier Green Garden",
      faq: [
        ["Quel est le prix du palmier décoratif chez Green Garden ?", "Le palmier décoratif est vendu 275 DT. Les frais de livraison sont déterminés selon votre région et vous sont communiqués avant confirmation."],
        ["Le palmier est-il livrable partout en Tunisie ?", "Oui, nous organisons la livraison dans toute la Tunisie. Plus la distance depuis notre dépôt de Nabeul est importante, plus le tarif de livraison peut varier."],
    ...
    en: {
      ...
      metaDescription: "Decorative palm tree for sale in Tunisia at 275 DT. Delivery across Tunisia, fees determined by region. Order on WhatsApp with Green Garden.",
      eyebrow: "Decorative palm tree",
      h1: "Palm Tree Tunisia: decorative palm tree at 275 DT",
      intro: "Green Garden sells and delivers decorative palm trees across Tunisia, at 275 DT. Delivery fees are determined based on your region and communicated to you before order confirmation.",
      breadcrumbLabel: "Palm Tree Tunisia",
      productDescription: "Ornamental decorative palm tree for a garden, terrace or villa entrance, deliverable across Tunisia.",
      ...
      pa: ["A symbol of the Mediterranean and Tunisian garden, the palm tree structures an outdoor space with a single subject: it adds height, light shade and an immediately upscale effect to a driveway, pool or villa entrance.",
        "Our decorative palm tree is sold individually at 275 DT and can be delivered across Tunisia. Unlike lawn, delivery is not included by default: it is calculated based on distance and your exact address, then confirmed before any order."],
      h2b: "Why choose our decorative palm tree?",
      listB: ["A specimen suited to the Tunisian climate, resistant to summer heat", "An immediate visual effect to structure a garden, entrance or terrace", "Limited maintenance once the palm tree is well established", "A clear, single price of 275 DT", "Delivery arranged across Tunisia, fees calculated by region"],
      faqH2: "Frequently asked questions about the Green Garden palm tree",
      faq: [
        ["What is the price of the decorative palm tree at Green Garden?", "The decorative palm tree is sold at 275 DT. Delivery fees are determined based on your region and communicated to you before confirmation."],
        ["Can the palm tree be delivered anywhere in Tunisia?", "Yes, we arrange delivery across Tunisia. The greater the distance from our Nabeul depot, the more the delivery rate may vary."],
    ...
    ar: {
      ...
      metaDescription: "بيع نخيل زينة في تونس بسعر 275 دينار. توصيل في كل تونس، مصاريف تُحدَّد حسب الجهة. اطلبوا عبر واتساب مع Green Garden.",
      eyebrow: "نخيل زينة",
      h1: "نخيل تونس: نخيل زينة بسعر 275 دينار",
      intro: "تبيع Green Garden وتوصل نخيل الزينة في كل تونس، بسعر 275 دينار. تُحدَّد مصاريف التوصيل حسب جهتكم وتُبلَّغ لكم قبل تأكيد الطلب.",
      breadcrumbLabel: "نخيل تونس",
      productDescription: "نخلة زينة للحديقة أو التراس أو مدخل الفيلا، قابلة للتوصيل في كل تونس.",
      ...
      pa: ["رمز الحديقة المتوسطية والتونسية، ينظم النخيل المساحة الخارجية بعنصر واحد: يضيف ارتفاعاً وظلاً خفيفاً وتأثيراً راقياً فورياً لممر أو مسبح أو مدخل فيلا.",
        "تُباع نخلة الزينة لدينا بالوحدة بسعر 275 دينار وقابلة للتوصيل في كل تونس. على عكس العشب، لا يُدرج التوصيل تلقائياً: يُحسب حسب المسافة وعنوانكم الدقيق، ثم يُؤكَّد قبل أي طلب."],
      h2b: "لماذا تختارون نخلة الزينة لدينا؟",
      listB: ["نخلة مكيّفة مع المناخ التونسي، مقاومة لحرارة الصيف", "تأثير بصري فوري لتنظيم حديقة أو مدخل أو تراس", "عناية محدودة بمجرد استقرار النخلة جيداً", "سعر واضح وموحد قدره 275 دينار", "توصيل مُنظَّم في كل تونس، مصاريف تُحسب حسب الجهة"],
      faqH2: "أسئلة شائعة حول نخيل Green Garden",
      faq: [
        ["ما هو سعر نخلة الزينة لدى Green Garden؟", "تُباع نخلة الزينة بسعر 275 دينار. تُحدَّد مصاريف التوصيل حسب جهتكم وتُبلَّغ لكم قبل التأكيد."],
        ["هل النخلة قابلة للتوصيل في كل تونس؟", "نعم، ننظم التوصيل في كل تونس. كلما زادت المسافة من مستودعنا بنابل، قد تتغير تعريفة التوصيل."],
...
function acheterPalmierPage(lang) {
  const T = {
    fr: {
      ...
      metaDescription: "Comment acheter un palmier décoratif en Tunisie avec Green Garden : prix 275 DT, livraison dans toute la Tunisie, commande simple par WhatsApp.",
      eyebrow: "Commander",
      h1: "Acheter un palmier en Tunisie avec Green Garden",
      intro: "Acheter un palmier décoratif en Tunisie est simple avec Green Garden : un prix fixe, une livraison organisée dans tout le pays et une commande finalisée par WhatsApp.",
      crumb: [["Palmier Tunisie", "/palmier-tunisie/"], ["Acheter un palmier", "/acheter-palmier/"]],
      h2a: "Comment acheter votre palmier en 3 étapes",
      listA: ["Contactez-nous par WhatsApp en précisant votre ville de livraison", "Recevez le tarif de livraison calculé selon votre région et confirmez votre commande", "Recevez votre palmier décoratif à 275 DT et procédez à la plantation"],
      h2b: "Récapitulatif du prix",
      headersB: ["Produit", "Prix", "Livraison"],
      rowsB: [["Palmier décoratif", "275 DT", "Sur devis, selon la région"]],
      ...
      faq: [
        ...
        ["Comment est calculé le tarif de livraison ?", "Il dépend de la distance entre notre dépôt de Nabeul et votre adresse, ainsi que du nombre de palmiers commandés."],
      ],
    },
    en: {
      title: "Buy a Palm Tree in Tunisia - Green Garden",
      metaDescription: "How to buy a decorative palm tree in Tunisia with Green Garden: price 275 DT, delivery across Tunisia, simple ordering via WhatsApp.",
      eyebrow: "Order",
      h1: "Buy a palm tree in Tunisia with Green Garden",
      intro: "Buying a decorative palm tree in Tunisia is simple with Green Garden: a fixed price, delivery arranged across the country and an order finalised on WhatsApp.",
      crumb: [["Palm Tree Tunisia", "/palmier-tunisie/"], ["Buy a palm tree", "/acheter-palmier/"]],
      h2a: "How to buy your palm tree in 3 steps",
      listA: ["Contact us on WhatsApp specifying your delivery city", "Receive the delivery rate calculated for your region and confirm your order", "Receive your decorative palm tree at 275 DT and plant it"],
      h2b: "Price summary",
      headersB: ["Product", "Price", "Delivery"],
      rowsB: [["Decorative palm tree", "275 DT", "On quote, based on region"]],
      ...
      faq: [
        ...
        ["How is the delivery rate calculated?", "It depends on the distance between our Nabeul depot and your address, as well as the number of palm trees ordered."],
      ],
    },
    ar: {
      title: "شراء نخلة في تونس - Green Garden",
      metaDescription: "كيفية شراء نخلة زينة في تونس مع Green Garden: سعر 275 دينار، توصيل في كل تونس، طلب بسيط عبر واتساب.",
      eyebrow: "الطلب",
      h1: "شراء نخلة في تونس مع Green Garden",
      intro: "شراء نخلة زينة في تونس أمر بسيط مع Green Garden: سعر ثابت، توصيل مُنظَّم في كل البلاد وطلب يُنجز عبر واتساب.",
      crumb: [["نخيل تونس", "/palmier-tunisie/"], ["شراء نخلة", "/acheter-palmier/"]],
      h2a: "كيف تشترون نخلتكم في 3 خطوات",
      listA: ["تواصلوا معنا عبر واتساب مع تحديد مدينة التوصيل", "استلموا تعريفة التوصيل المحسوبة حسب جهتكم وأكدوا طلبيتكم", "استلموا نخلة الزينة بسعر 275 دينار وابدؤوا الغرس"],
      h2b: "ملخص السعر",
      headersB: ["المنتج", "السعر", "التوصيل"],
      rowsB: [["نخلة زينة", "275 دينار", "حسب الطلب، حسب الجهة"]],
      ...
      faq: [
        ...
        ["كيف تُحسب تعريفة التوصيل؟", "تعتمد على المسافة بين مستودعنا بنابل وعنوانكم، وكذلك عدد النخيل المطلوب."],
      ],
    },
  };
  const t = T[lang];
...
function palmierJardinPage(lang) {
  const T = {
    fr: {
      ...
      metaDescription: "Palmier de jardin en Tunisie pour structurer une allée, une piscine ou un espace vert. Palmier décoratif Green Garden à 275 DT, livré dans toute la Tunisie.",
      ...
      ctaText: "Palmier décoratif à 275 DT et gazon naturel à 9 DT/m², livraison gratuite dans le Grand Tunis et à Nabeul.",
    ...
    en: {
      ...
      metaDescription: "Garden palm tree in Tunisia to structure a driveway, pool or green space. Green Garden decorative palm tree at 275 DT, delivered across Tunisia.",
      ...
      ctaText: "Decorative palm tree at 275 DT and natural lawn at 9 DT/sqm, free delivery in Greater Tunis and Nabeul.",
    ...
    ar: {
      ...
      metaDescription: "نخيل الحديقة في تونس لتنظيم ممر أو مسبح أو مساحة خضراء. نخيل زينة من Green Garden بسعر 275 دينار، يُوصَّل في كل تونس.",
      ...
      ctaText: "نخلة زينة بسعر 275 دينار وعشب طبيعي بسعر 9 دينار/م²، توصيل مجاني في تونس الكبرى ونابل.",
...
function palmierDecoratifPage(lang) {
  const T = {
    fr: {
      ...
      metaDescription: "Palmier décoratif en Tunisie pour terrasse, entrée de villa ou intérieur lumineux. Palmier Green Garden à 275 DT, livraison dans toute la Tunisie.",
    ...
    en: {
      ...
      metaDescription: "Decorative palm tree in Tunisia for terrace, villa entrance or bright interior. Green Garden palm tree at 275 DT, delivery across Tunisia.",
    ...
    ar: {
      ...
      metaDescription: "نخيل زينة في تونس للتراس أو مدخل الفيلا أو الداخل المضيء. نخيل Green Garden بسعر 275 دينار، توصيل في كل تونس.",
      eyebrow: "زينة خارجية",
