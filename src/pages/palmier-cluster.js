  ...
  const T = {
    fr: {
      ...
      pa: ["Symbole du jardin méditerranéen et tunisien, le palmier structure un extérieur en un seul sujet : il apporte de la hauteur, de l'ombre légère et un effet immédiatement qualitatif à une allée, une piscine ou une entrée de villa.",
        "Notre palmier décoratif est vendu à l'unité à 275 DT et livrable dans toute la Tunisie. Comme pour le gazon, la livraison est gratuite dans le Grand Tunis et à Nabeul ; ailleurs, elle est calculée selon la distance et votre adresse exacte, puis confirmée avant toute commande."],
      ...
      faq: [
        ["Quel est le prix du palmier décoratif chez Green Garden ?", "Le palmier décoratif est vendu 275 DT. La livraison est gratuite dans le Grand Tunis et à Nabeul ; ailleurs en Tunisie, elle est facturée sur devis selon la distance."],
    ...
    en: {
      ...
      pa: ["A symbol of the Mediterranean and Tunisian garden, the palm tree structures an outdoor space with a single subject: it adds height, light shade and an immediately upscale effect to a driveway, pool or villa entrance.",
        "Our decorative palm tree is sold individually at 275 DT and can be delivered across Tunisia. Like our lawn, delivery is free in Greater Tunis and Nabeul; elsewhere, it is calculated based on distance and your exact address, then confirmed before any order."],
      h2b: "Why choose our decorative palm tree?",
      listB: ["A specimen suited to the Tunisian climate, resistant to summer heat", "An immediate visual effect to structure a garden, entrance or terrace", "Limited maintenance once the palm tree is well established", "A clear, single price of 275 DT", "Free delivery in Greater Tunis and Nabeul, arranged on quote elsewhere"],
      faqH2: "Frequently asked questions about the Green Garden palm tree",
      faq: [
        ["What is the price of the decorative palm tree at Green Garden?", "The decorative palm tree is sold at 275 DT. Delivery is free in Greater Tunis and Nabeul; elsewhere in Tunisia, it is charged on quote based on distance."],
    ...
    ar: {
      ...
      pa: ["رمز الحديقة المتوسطية والتونسية، ينظم النخيل المساحة الخارجية بعنصر واحد: يضيف ارتفاعاً وظلاً خفيفاً وتأثيراً راقياً فورياً لممر أو مسبح أو مدخل فيلا.",
        "تُباع نخلة الزينة لدينا بالوحدة بسعر 275 دينار وقابلة للتوصيل في كل تونس. مثل العشب، التوصيل مجاني في تونس الكبرى ونابل؛ في بقية الجهات، يُحسب حسب المسافة وعنوانكم الدقيق، ثم يُؤكَّد قبل أي طلب."],
      h2b: "لماذا تختارون نخلة الزينة لدينا؟",
      listB: ["نخلة مكيّفة مع المناخ التونسي، مقاومة لحرارة الصيف", "تأثير بصري فوري لتنظيم حديقة أو مدخل أو تراس", "عناية محدودة بمجرد استقرار النخلة جيداً", "سعر واضح وموحد قدره 275 دينار", "توصيل مجاني في تونس الكبرى ونابل، ومُنظَّم حسب الطلب في بقية الجهات"],
      faqH2: "أسئلة شائعة حول نخيل Green Garden",
      faq: [
        ["ما هو سعر نخلة الزينة لدى Green Garden؟", "تُباع نخلة الزينة بسعر 275 دينار. التوصيل مجاني في تونس الكبرى ونابل؛ في بقية تونس، يُحتسب حسب الطلب وحسب المسافة."],
...
function acheterPalmierPage(lang) {
  const T = {
    fr: {
      ...
      metaDescription: "Comment acheter un palmier décoratif en Tunisie avec Green Garden : prix 275 DT, livraison gratuite Grand Tunis et Nabeul, commande simple par WhatsApp.",
      eyebrow: "Commander",
      ...
      listA: ["Contactez-nous par WhatsApp en précisant votre ville de livraison", "Livraison gratuite au Grand Tunis et à Nabeul ; ailleurs, recevez le tarif calculé selon votre région et confirmez votre commande", "Recevez votre palmier décoratif à 275 DT et procédez à la plantation"],
      h2b: "Récapitulatif du prix",
      headersB: ["Produit", "Prix", "Livraison"],
      rowsB: [["Palmier décoratif", "275 DT", "Gratuite (Grand Tunis, Nabeul) / sur devis ailleurs"]],
    ...
    en: {
      ...
      metaDescription: "How to buy a decorative palm tree in Tunisia with Green Garden: price 275 DT, free delivery in Greater Tunis and Nabeul, simple ordering via WhatsApp.",
      eyebrow: "Order",
      ...
      listA: ["Contact us on WhatsApp specifying your delivery city", "Free delivery in Greater Tunis and Nabeul; elsewhere, receive the rate calculated for your region and confirm your order", "Receive your decorative palm tree at 275 DT and plant it"],
      h2b: "Price summary",
      headersB: ["Product", "Price", "Delivery"],
      rowsB: [["Decorative palm tree", "275 DT", "Free (Greater Tunis, Nabeul) / on quote elsewhere"]],
    ...
    ar: {
      ...
      metaDescription: "كيفية شراء نخلة زينة في تونس مع Green Garden: سعر 275 دينار، توصيل مجاني في تونس الكبرى ونابل، طلب بسيط عبر واتساب.",
      eyebrow: "الطلب",
      ...
      listA: ["تواصلوا معنا عبر واتساب مع تحديد مدينة التوصيل", "توصيل مجاني في تونس الكبرى ونابل؛ في بقية الجهات، استلموا التعريفة المحسوبة حسب جهتكم وأكدوا طلبيتكم", "استلموا نخلة الزينة بسعر 275 دينار وابدؤوا الغرس"],
      h2b: "ملخص السعر",
      headersB: ["المنتج", "السعر", "التوصيل"],
      rowsB: [["نخلة زينة", "275 دينار", "مجاني (تونس الكبرى، نابل) / حسب الطلب في بقية الجهات"]],
