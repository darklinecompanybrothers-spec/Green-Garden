...
const PAGE_TEXT = {
  fr: {
    ...
    categoriesLinks: [
      ...
      ["Arbres d'ornement", "/produits/arbres/"],
      ["Arbustes", "/produits/arbustes/"],
      ["Terre végétale", "/produits/terre-vegetale/"],
      ["Gravier décoratif", "/produits/gravier-decoratif/"],
    ],
    servicesTitle: "Services",
    servicesLinks: [
      ["Nos services", "/services/"],
      ["Pose de gazon", "/services/pose-gazon/"],
      ["Plantation de palmier", "/services/plantation-palmier/"],
    ],
  ...
  en: {
    ...
    categoriesLinks: [
      ...
      ["Ornamental trees", "/produits/arbres/"],
      ["Shrubs", "/produits/arbustes/"],
      ["Topsoil", "/produits/terre-vegetale/"],
      ["Decorative gravel", "/produits/gravier-decoratif/"],
    ],
    servicesTitle: "Services",
    servicesLinks: [
      ["Our services", "/services/"],
      ["Lawn laying", "/services/pose-gazon/"],
      ["Palm tree planting", "/services/plantation-palmier/"],
    ],
  ...
  ar: {
    ...
    categoriesLinks: [
      ...
      ["أشجار الزينة", "/produits/arbres/"],
      ["شجيرات", "/produits/arbustes/"],
      ["تراب زراعي", "/produits/terre-vegetale/"],
      ["حصى زخرفي", "/produits/gravier-decoratif/"],
    ],
    servicesTitle: "الخدمات",
    servicesLinks: [
      ["خدماتنا", "/services/"],
      ["تركيب العشب", "/services/pose-gazon/"],
      ["غرس النخيل", "/services/plantation-palmier/"],
    ],
...
function renderSitemapPage(lang) {
  ...
  const SECTIONS = [
    ...
    { title: t.servicesTitle, links: t.servicesLinks.map(([label, path]) => ({ label, path: p(path) })) },
    {
