...
function pillarPage(lang) {
  const T = {
    ...
    ar: {
      title: "عشب تونس – 9 دينار/م²، توصيل مجاني | Green Garden",
...
function gazonEnRouleauPage(lang) {
  const T = {
    ...
    ar: {
      ...
      metaDescription: "عشب على شكل لفائف بسعر 9 دينار/م² في تونس: أبعاد الألواح، حساب المساحة وخطوات التركيب. توصيل مجاني في تونس الكبرى ونابل.",
      eyebrow: "عشب طبيعي",
...
function acheterGazonPage(lang) {
  const T = {
    ...
    ar: {
      ...
      metaDescription: "اشتروا عشباً طبيعياً في تونس بسعر 9 دينار/م²، توصيل مجاني في تونس الكبرى ونابل. طلب بسيط في 3 خطوات عبر واتساب.",
      eyebrow: "الطلب",
