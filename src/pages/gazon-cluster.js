...
function gazonNaturelPage(lang) {
  const T = {
    fr: {
      ...
      metaDescription: "Tout savoir sur le gazon naturel en Tunisie : avantages face au gazon synthétique, entretien, climat, prix au m². Green Garden vous conseille avant votre achat.",
      eyebrow: "Gazon naturel",
      h1: "Gazon naturel en Tunisie : ce qu'il faut savoir avant d'acheter",
      intro: "Le gazon naturel reste le choix privilégié des jardins tunisiens pour son rendu authentique, sa fraîcheur et son impact positif sur le microclimat d'un extérieur. Voici ce qui le distingue du gazon synthétique et comment bien le choisir.",
    ...
    en: {
      title: "Natural Lawn Tunisia: Benefits and Care - Green Garden",
      metaDescription: "Everything about natural lawn in Tunisia: benefits over synthetic lawn, care, climate, price per sqm. Green Garden advises you before you buy.",
      eyebrow: "Natural lawn",
      h1: "Natural lawn in Tunisia: what you need to know before buying",
      intro: "Natural lawn remains the preferred choice for Tunisian gardens for its authentic look, freshness and positive impact on an outdoor microclimate. Here is what sets it apart from synthetic lawn and how to choose well.",
    ...
    ar: {
      title: "عشب طبيعي تونس: المزايا والعناية - Green Garden",
      metaDescription: "كل شيء عن العشب الطبيعي في تونس: مزاياه مقابل العشب الاصطناعي، العناية، المناخ، السعر بالمتر المربع. تنصحكم Green Garden قبل الشراء.",
      eyebrow: "عشب طبيعي",
      h1: "العشب الطبيعي في تونس: ما يجب معرفته قبل الشراء",
      intro: "يبقى العشب الطبيعي الخيار المفضل للحدائق التونسية لمظهره الأصيل ونضارته وتأثيره الإيجابي على المناخ المصغر للمساحة الخارجية. إليكم ما يميزه عن العشب الاصطناعي وكيفية اختياره جيداً.",
