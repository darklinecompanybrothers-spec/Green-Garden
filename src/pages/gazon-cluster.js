...
function pillarPage(lang) {
  const T = {
    fr: {
      ...
      metaDescription: "Gazon naturel en rouleau à 9 DT/m² en Tunisie. Livraison partout dans le pays, frais calculés selon votre adresse. Commandez sur WhatsApp.",
      eyebrow: "Gazon naturel",
      h1: "Gazon Tunisie : gazon naturel en rouleau à 9 DT/m²",
      intro: "Green Garden vend et livre du gazon naturel en rouleau partout en Tunisie, au prix clair de 9 DT/m². Les frais de livraison sont calculés selon votre adresse et communiqués avant confirmation. Une solution rapide pour obtenir un jardin vert et homogène dès la pose, sans attendre des semaines de germination.",
      ...
      rowsC: [["Grand Tunis", "9 DT/m²", "Selon votre adresse"], ["Nabeul", "9 DT/m²", "Selon votre adresse"], ["Sousse, Monastir, Sfax, Bizerte, Gabès, Hammamet et autres régions", "9 DT/m²", "Selon votre adresse"]],
      faqH2: "Questions fréquentes sur le gazon Green Garden",
      faq: [
        ["Quel est le prix du gazon naturel en Tunisie chez Green Garden ?", "Notre gazon naturel en rouleau est vendu 9 DT/m² partout en Tunisie. Les frais de livraison sont calculés selon votre adresse et vous sont communiqués avant toute confirmation de commande."],
    ...
    en: {
      ...
      metaDescription: "Natural rolled lawn at 9 DT/sqm in Tunisia. Delivered nationwide, fees calculated for your address. Order on WhatsApp.",
      eyebrow: "Natural lawn",
      h1: "Lawn Tunisia: natural rolled lawn at 9 DT/sqm",
      intro: "Green Garden sells and delivers natural rolled lawn across Tunisia, at the clear price of 9 DT/sqm. Delivery fees are calculated for your address and confirmed before you order. A fast way to get a green, even garden right after laying, without weeks of waiting for seeds to grow.",
      ...
      listB: ["A green, even result right after laying, no seeding or waiting", "A variety suited to the Tunisian climate, hot and dry for much of the year", "A clear, single price: 9 DT/sqm, no surprises", "Delivery anywhere in Tunisia, with fees confirmed before you order", "Laying and care advice provided with every order"],
      h2c: "Price and delivery zones",
      headersC: ["Zone", "Lawn rate", "Delivery"],
      rowsC: [["Greater Tunis", "9 DT/sqm", "Quoted by address"], ["Nabeul", "9 DT/sqm", "Quoted by address"], ["Sousse, Monastir, Sfax, Bizerte, Gabes, Hammamet and other regions", "9 DT/sqm", "Quoted by address"]],
      faqH2: "Frequently asked questions about Green Garden lawn",
      faq: [
        ["What is the price of natural lawn in Tunisia at Green Garden?", "Our natural rolled lawn is sold at 9 DT/sqm across Tunisia. Delivery fees are calculated for your address and confirmed before you place your order."],
    ...
    ar: {
      title: "عشب تونس – 9 دينار/م²، توصيل في كل تونس | Green Garden",
      metaDescription: "عشب طبيعي على شكل لفائف بسعر 9 دينار/م² في تونس. توصيل في كل الجهات، بمصاريف تُحتسب حسب عنوانكم. اطلبوا عبر واتساب.",
      eyebrow: "عشب طبيعي",
      h1: "عشب تونس: عشب طبيعي على شكل لفائف بسعر 9 دينار/م²",
      intro: "تبيع Green Garden وتوصل العشب الطبيعي على شكل لفائف في كل تونس، بسعر واضح قدره 9 دينار/م². تُحتسب مصاريف التوصيل حسب عنوانكم وتُبلَّغ قبل تأكيد الطلب. حل سريع للحصول على حديقة خضراء ومتجانسة فور التركيب، دون انتظار أسابيع من الإنبات.",
      ...
      listB: ["نتيجة خضراء ومتجانسة فور التركيب، دون بذر أو انتظار", "صنف مكيّف مع المناخ التونسي، الحار والجاف معظم أوقات السنة", "سعر واضح وموحد: 9 دينار/م²، دون مفاجآت", "توصيل في كل تونس، بمصاريف تُبلَّغ قبل التأكيد", "نصائح تركيب وعناية مع كل طلبية"],
      h2c: "السعر ومناطق التوصيل",
      headersC: ["المنطقة", "سعر العشب", "التوصيل"],
      rowsC: [["تونس الكبرى", "9 دينار/م²", "حسب عنوانكم"], ["نابل", "9 دينار/م²", "حسب عنوانكم"], ["سوسة، المنستير، صفاقس، بنزرت، قابس، الحمامات ومناطق أخرى", "9 دينار/م²", "حسب عنوانكم"]],
      faqH2: "أسئلة شائعة حول عشب Green Garden",
      faq: [
        ["ما هو سعر العشب الطبيعي في تونس لدى Green Garden؟", "يُباع عشبنا الطبيعي على شكل لفائف بسعر 9 دينار/م² في كل تونس. تُحتسب مصاريف التوصيل حسب عنوانكم وتُبلَّغ قبل تأكيد أي طلب."],
...
function gazonEnRouleauPage(lang) {
  const T = {
    fr: {
      ...
      ctaText: "9 DT/m², livraison calculée selon votre adresse.",
    ...
    en: {
      ...
      ctaText: "9 DT/sqm, delivery quoted by address.",
    ...
    ar: {
      title: "عشب على شكل لفائف تونس – 9 دينار/م² | Green Garden",
      metaDescription: "عشب على شكل لفائف بسعر 9 دينار/م² في تونس: أبعاد الألواح، حساب المساحة وخطوات التركيب. توصيل في كل تونس حسب عنوانكم.",
      eyebrow: "عشب طبيعي",
      ...
      ctaText: "9 دينار/م²، توصيل حسب عنوانكم.",
...
function acheterGazonPage(lang) {
  const T = {
    fr: {
      ...
      rowsB: [["Gazon naturel en rouleau", "9 DT/m²", "Selon votre adresse"]],
    ...
    en: {
      ...
      rowsB: [["Natural rolled lawn", "9 DT/sqm", "Quoted by address"]],
    ...
    ar: {
      title: "شراء عشب طبيعي تونس – 9 دينار/م² | Green Garden",
      metaDescription: "اشتروا عشباً طبيعياً في تونس بسعر 9 دينار/م²، بمصاريف توصيل تُحتسب حسب عنوانكم. طلب بسيط في 3 خطوات عبر واتساب.",
      eyebrow: "الطلب",
      ...
      rowsB: [["عشب طبيعي على شكل لفائف", "9 دينار/م²", "حسب عنوانكم"]],
...
function gazonGrandTunisPage(lang) {
  const T = {
    fr: {
      title: "Gazon Grand Tunis | Livraison rapide à 9 DT/m² - Green Garden",
      metaDescription: "Gazon naturel en rouleau livré dans tout le Grand Tunis (Tunis, Ariana, Ben Arous, Manouba) à 9 DT/m². Commandez avec Green Garden.",
      eyebrow: "Gazon local",
      h1: "Gazon Grand Tunis : livraison rapide à 9 DT/m²",
      intro: "Le Grand Tunis (Tunis, Ariana, Ben Arous, Manouba) est l'une des régions que nous livrons le plus rapidement en gazon naturel en rouleau, au prix unique de 9 DT/m². Les frais de livraison sont calculés selon votre adresse et communiqués avant confirmation.",
    ...
    en: {
      title: "Lawn Greater Tunis | Fast Delivery at 9 DT/sqm - Green Garden",
      metaDescription: "Natural rolled lawn delivered across Greater Tunis (Tunis, Ariana, Ben Arous, Manouba) at 9 DT/sqm. Order with Green Garden.",
      eyebrow: "Local lawn",
      h1: "Lawn Greater Tunis: fast delivery at 9 DT/sqm",
      intro: "Greater Tunis (Tunis, Ariana, Ben Arous, Manouba) is one of the regions we deliver natural rolled lawn to fastest, at the single price of 9 DT/sqm. Delivery fees are calculated for your address and confirmed before you order.",
    ...
    ar: {
      title: "عشب تونس الكبرى | توصيل سريع بسعر 9 دينار/م² - Green Garden",
      metaDescription: "عشب طبيعي على شكل لفائف يُوصَّل في كل تونس الكبرى (تونس، أريانة، بن عروس، منوبة) بسعر 9 دينار/م². اطلبوا مع Green Garden.",
      eyebrow: "عشب محلي",
      h1: "عشب تونس الكبرى: توصيل سريع بسعر 9 دينار/م²",
      intro: "تُعد تونس الكبرى (تونس، أريانة، بن عروس، منوبة) من أسرع الجهات التي نوصل إليها العشب الطبيعي على شكل لفائف، بسعر موحد قدره 9 دينار/م². تُحتسب مصاريف التوصيل حسب عنوانكم وتُبلَّغ قبل تأكيد الطلب.",
...
function gazonNabeulPage(lang) {
  const T = {
    fr: {
      title: "Gazon Nabeul | Livraison rapide à 9 DT/m² - Green Garden",
      metaDescription: "Gazon naturel en rouleau livré à Nabeul et sa région à 9 DT/m². Green Garden est basé à Nabeul : délais les plus courts du réseau.",
      eyebrow: "Gazon local",
      h1: "Gazon Nabeul : livraison rapide à 9 DT/m²",
    ...
    en: {
      title: "Lawn Nabeul | Fast Delivery at 9 DT/sqm - Green Garden",
      metaDescription: "Natural rolled lawn delivered to Nabeul and its region at 9 DT/sqm. Green Garden is based in Nabeul: shortest lead times in the network.",
      eyebrow: "Local lawn",
      h1: "Lawn Nabeul: fast delivery at 9 DT/sqm",
    ...
    ar: {
      title: "عشب نابل | توصيل سريع بسعر 9 دينار/م² - Green Garden",
      metaDescription: "عشب طبيعي على شكل لفائف يُوصَّل إلى نابل وجهتها بسعر 9 دينار/م². مقر Green Garden في نابل: أقصر آجال في الشبكة.",
      eyebrow: "عشب محلي",
      h1: "عشب نابل: توصيل سريع بسعر 9 دينار/م²",
