...
function pillarPage(lang) {
  const T = {
    fr: {
      ...
      quoteH2: "Demandez votre devis en un message",
      quoteIntro: "Indiquez votre surface, le type de gazon et l'épaisseur de terre souhaitée : votre demande est mise en forme et envoyée sur WhatsApp. Nous vous communiquons le prix et les frais de livraison en retour.",
    ...
    en: {
      ...
      quoteH2: "Request your quote in one message",
      quoteIntro: "Enter your area, the lawn type and the soil depth you want: your request is put together and sent on WhatsApp. We reply with the price and the delivery fees.",
    ...
    ar: {
      ...
      quoteH2: "اطلبوا عرض سعركم برسالة واحدة",
      quoteIntro: "أدخلوا مساحتكم ونوع العشب وسمك التربة المرغوب: تُصاغ طلبيتكم وتُرسل عبر واتساب. ونبلغكم بالسعر ومصاريف التوصيل في المقابل.",
...
function acheterGazonPage(lang) {
  const T = {
    fr: {
      ...
      faq: [
        ["Quelle est la surface minimum de commande ?", "La commande minimum est de 50 m² de gazon naturel. Au-delà de ce seuil, vous commandez la surface exacte dont vous avez besoin, calculée au m²."],
    ...
    en: {
      ...
      faq: [
        ["What is the minimum order area?", "The minimum order is 50 sqm of natural lawn. Above that threshold, you order the exact area you need, calculated per sqm."],
    ...
    ar: {
      ...
      faq: [
        ["ما هي المساحة الدنيا للطلب؟", "الحد الأدنى للطلب هو 50 م² من العشب الطبيعي. وفوق هذه العتبة، تطلبون المساحة الدقيقة التي تحتاجونها، محسوبة بالمتر المربع."],
...
function gazonGrandTunisPage(lang) {
  const T = {
    fr: {
      ...
      pa: ["Tunis, Ariana, Ben Arous et Manouba comptent parmi les secteurs que nous desservons le plus souvent. Que vous soyez à La Marsa, au Bardo, à Ariana ville ou à Ben Arous, notre équipe organise la livraison selon votre disponibilité et vous communique les frais avant confirmation."],
    ...
    en: {
      ...
      pa: ["Tunis, Ariana, Ben Arous and Manouba are among the areas we serve most often. Whether you are in La Marsa, Le Bardo, Ariana city or Ben Arous, our team arranges delivery according to your availability and confirms the fee before you order."],
    ...
    ar: {
      ...
      pa: ["تُعد تونس وأريانة وبن عروس ومنوبة من أكثر المناطق التي نخدمها. سواء كنتم بالمرسى أو الباردو أو مدينة أريانة أو بن عروس، ينظم فريقنا التوصيل حسب توفركم ويبلغكم بالمصاريف قبل التأكيد."],
