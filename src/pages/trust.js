...
const POURQUOI_TEXT = {
  fr: {
    ...
    related: [
      ["Gazon Tunisie", "/gazon-tunisie/", "9 DT/m², livraison selon votre adresse"],
  ...
  en: {
    ...
    related: [
      ["Lawn Tunisia", "/gazon-tunisie/", "9 DT/sqm, delivery quoted by address"],
  ...
  ar: {
    ...
    label: "لماذا نحن",
    listH2: "ما يميزنا",
    list: ["سعر موحد وشفاف: 9 دينار/م² للعشب، 490 دينار/م للنخلة، دون تكلفة مخفية", "توصيل في كل تونس، للعشب الطبيعي ونخيل الزينة معاً", "مصاريف توصيل تُحتسب حسب عنوانكم وتُبلَّغ قبل التأكيد", "تواصل سريع ومباشر عبر واتساب، دون حساب يُنشأ", "نصائح تركيب وعناية مع كل طلبية", "عرض كامل: عشب، نخيل، نباتات داخلية وأسمدة"],
    ...
    related: [
      ["عشب تونس", "/gazon-tunisie/", "9 دينار/م²، توصيل حسب عنوانكم"],
