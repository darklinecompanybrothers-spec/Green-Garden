...
const POURQUOI_TEXT = {
  fr: {
    ...
    metaDescription: "Prix clair, livraison dans toute la Tunisie, réactivité WhatsApp : pourquoi choisir Green Garden pour votre gazon et vos palmiers.",
    ...
    list: ["Un prix clair et dégressif : 15 DT/m² sous 50 m² et 9 DT/m² à partir de 50 m² pour le gazon, 490 DT/m pour le palmier, sans coût caché", "Une livraison dans toute la Tunisie, gazon naturel comme palmier décoratif", "Des frais de livraison calculés selon votre adresse et annoncés avant confirmation", "Une prise de contact rapide et directe par WhatsApp, sans compte à créer", "Des conseils de pose et d'entretien fournis avec chaque commande", "Une offre complète : gazon, palmiers, plantes d'intérieur et engrais"],
    ...
    related: [
      ["Gazon Tunisie", "/gazon-tunisie/", "15 ou 9 DT/m² selon la surface, livraison selon votre adresse"],
      ["Palmier Tunisie", "/palmier-tunisie/", "490 DT/m, livraison selon votre adresse"],
    ],
  },
  en: {
    title: "Why Choose Green Garden? | Lawn & Palm Tree in Tunisia",
    metaDescription: "Clear pricing, nationwide delivery, WhatsApp responsiveness: why choose Green Garden for your lawn and palm trees.",
    eyebrow: "Green Garden",
    ...
    list: ["A clear, tapering price: 15 DT/sqm under 50 sqm and 9 DT/sqm from 50 sqm for lawn, 490 DT/m for the palm tree, no hidden cost", "Delivery across all of Tunisia, both natural lawn and the decorative palm tree", "Delivery fees calculated for your address and confirmed before you order", "Fast, direct contact via WhatsApp, no account needed", "Laying and care advice provided with every order", "A complete range: lawn, palm trees, indoor plants and fertilizer"],
    ...
    related: [
      ["Lawn Tunisia", "/gazon-tunisie/", "15 or 9 DT/sqm depending on area, delivery quoted by address"],
      ["Palm Tree Tunisia", "/palmier-tunisie/", "490 DT/m, delivery quoted by address"],
    ],
  },
  ar: {
    title: "لماذا تختارون Green Garden؟ | عشب ونخيل في تونس",
    metaDescription: "سعر واضح، توصيل في كل تونس، سرعة استجابة عبر واتساب: لماذا تختارون Green Garden لعشبكم ونخيلكم.",
    eyebrow: "Green Garden",
    ...
    label: "لماذا نحن",
    listH2: "ما يميزنا",
    list: ["سعر واضح ومتناقص: 15 دينار/م² دون 50 م² و9 دينار/م² ابتداءً من 50 م² للعشب، 490 دينار/م للنخلة، دون تكلفة مخفية", "توصيل في كل تونس، للعشب الطبيعي ونخيل الزينة معاً", "مصاريف توصيل تُحتسب حسب عنوانكم وتُبلَّغ قبل التأكيد", "تواصل سريع ومباشر عبر واتساب، دون حساب يُنشأ", "نصائح تركيب وعناية مع كل طلبية", "عرض كامل: عشب، نخيل، نباتات داخلية وأسمدة"],
    ...
    related: [
      ["عشب تونس", "/gazon-tunisie/", "15 أو 9 دينار/م² حسب المساحة، توصيل حسب عنوانكم"],
      ["نخيل تونس", "/palmier-tunisie/", "490 دينار/م، توصيل حسب عنوانكم"],
    ],
  },
};
...
const APROPOS_TEXT = {
  fr: {
    ...
    h2a: "Notre activité",
    pa: [
      `Basé à ${SITE.address.locality}, Green Garden livre du gazon naturel en rouleau et des palmiers décoratifs dans toute la Tunisie, avec des frais de livraison calculés selon votre adresse et communiqués avant confirmation.`,
  ...
  en: {
    ...
    h2a: "Our activity",
    pa: [
      `Based in ${SITE.address.locality}, Green Garden delivers natural rolled lawn and decorative palm trees across Tunisia, with delivery fees calculated for your address and confirmed before you order.`,
  ...
  ar: {
    ...
    h2a: "نشاطنا",
    pa: [
      `تُوصل Green Garden، ومقرها ${SITE.address.locality}، العشب الطبيعي على شكل لفائف ونخيل الزينة في كل تونس، بمصاريف توصيل تُحتسب حسب عنوانكم وتُبلَّغ قبل التأكيد.`,
...
const FAQ_TEXT = {
  fr: {
    ...
    items: [
      ["Quels produits vend Green Garden ?", "Green Garden vend du gazon naturel en rouleau (15 DT/m² sous 50 m², 9 DT/m² à partir de 50 m²), des palmiers décoratifs (490 DT/m), des plantes d'intérieur décoratives et des engrais."],
      ["Dans quelles régions livrez-vous ?", "Le gazon naturel et le palmier décoratif sont livrables partout en Tunisie. Les frais de livraison dépendent de votre adresse et vous sont communiqués avant toute confirmation de commande."],
  ...
  en: {
    ...
    items: [
      ["What products does Green Garden sell?", "Green Garden sells natural rolled lawn (15 DT/sqm under 50 sqm, 9 DT/sqm from 50 sqm), decorative palm trees (490 DT/m), decorative indoor plants and fertilizer."],
      ["Which regions do you deliver to?", "Natural lawn and the decorative palm tree can be delivered anywhere in Tunisia. Delivery fees depend on your address and are confirmed before you place your order."],
  ...
  ar: {
    ...
    items: [
      ["ما هي المنتجات التي تبيعها Green Garden؟", "تبيع Green Garden عشباً طبيعياً على شكل لفائف (15 دينار/م² دون 50 م²، 9 دينار/م² ابتداءً من 50 م²)، نخيل زينة (490 دينار/م)، نباتات داخلية زخرفية وأسمدة."],
      ["إلى أي جهات توصلون؟", "يمكن توصيل العشب الطبيعي ونخيل الزينة في كل أنحاء تونس. تعتمد مصاريف التوصيل على عنوانكم وتُبلَّغ قبل تأكيد أي طلب."],
